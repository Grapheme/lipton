                ...
                @foreach($users as $index => $user)
                    ...
                    <tr>
                        ...
                        <td style="vertical-align:top;font-size:12px;">
                            ...
                            {{ Form::select('number_week', array('Выберите неделю','1 неделя','2 неделя','3 неделя','4 неделя','5 неделя','6 неделя','7 неделя','8 неделя','9 неделя','10 неделя'), NULL, array('style'=>'width:100px;')) }}<br>
