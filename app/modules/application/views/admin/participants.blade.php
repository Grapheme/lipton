                    ...
                    <tr class="vertical-middle">
                        ...
                        @elseif(!empty($user['photo']))
                            <img height="100px" src="{{ $user['photo'] }}" alt="{{ $user['name'] }}"
                                 class="{{ $user['name'] }}">
                        @else
                            <img height="100px" src="{{ asset(Config::get('site.theme_path').'/images/avatar_default.png') }}" alt="{{ $user['name'] }}"
                                 class="{{ $user['name'] }}">
                        @endif
                        </td>
                        <td>
                            ...
                            {{ Form::text('number_week', ($user['number_week'] > 0 ? $user['number_week'] : ''), array('style'=>'width:30px;') ) }} Номер недели <br>
