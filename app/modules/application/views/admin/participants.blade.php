                    ...
                    @foreach($users as $index => $user)
                        ...
                        <tr class="vertical-middle">
                            ...
                            <td>
                                ...
                                {{ Form::text('number_week', ($user['number_week'] > 0 ? $user['number_week'] : ''), array('style'=>'width:30px;') ) }}
                                Номер недели <br>
                            ...
                            <td>
                                <div style="margin-top: 50px">
                                    @if(count($user['writing']) && !empty($user['writing']['writing']))
                                        <p><a target="_blank"
                                              href="{{ URL::route('show.participant.writing', $user['writing']['id'].'-'.BaseController::stringTranslite($user['name'].'-'.$user['surname'])) }}">Смотреть
                                                рассказ</a></p>
