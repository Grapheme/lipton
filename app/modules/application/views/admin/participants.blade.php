                    ...
                    @foreach($users as $index => $user)
                        ...
                        <tr class="vertical-middle">
                            ...
                            <td style="vertical-align:top;">
                                ...
                                {{ Form::select('number_week', array('1 неделя','2 неделя','3 неделя','4 неделя','5 неделя','6 неделя','7 неделя','8 неделя','9 неделя','10 неделя'), NULL, array('style'=>'width:130px;')) }}
                                <br>
                            ...
                            <td style="vertical-align:top;">
                                <div style="margin-top: 50px">
                                    @if(count($user['writing']) && !empty($user['writing']['writing']))
                                        <p><a target="_blank"
                                              href="{{ URL::route('show.participant.writing', $user['writing']['id'].'-'.BaseController::stringTranslite($user['name'].'-'.$user['surname'])) }}">Рассказ
                                                участника</a></p>
